// Service sale : touche aux "variables globales" du root
const root = require("../../index");
const nowDate = require("../utils/date");
const { getNow } = require("../utils/time"); // doublon

function makeId() {
  return "t" + Math.floor(Math.random() * 100000); // collisions possibles
}
...
exports.deleteTicket = (id) => {
  ...
  root.tickets = root.tickets.filter(t => t.id != id); // BUG: remplace root.tickets sans refléter exports du root
